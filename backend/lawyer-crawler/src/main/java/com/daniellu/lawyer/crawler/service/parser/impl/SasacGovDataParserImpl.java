...
/**
 * 国务院国资委官网页面解析器
 * 支持的URL前缀为http://www.sasac.gov.cn
 *
 * @author Daniel Lu
 * @since 2026-01-17
 */
@Component
@Slf4j
public class SasacGovDataParserImpl extends AbstractDataParser {
    ...
    protected Object parseMap(Map<String, Object> data, Map<String, Object> metadata) {
        throw new UnsupportedOperationException("parseMap is not supported for SasacGovDataParserImpl");
    }
    ...
    private ArticleDTO parseArticle(Map<String, Object> item, String baseUrl) {
        ...
        // 去除方括号
        publishedAtStr = publishedAtStr.replaceAll("^\\[", "").replaceAll("\\]$", "");
     ...
     * @return 解析后的LocalDateTime对象，解析失败返回null
     */
    private LocalDateTime parseDateTimeWithTime(String dateTimeStr) {
        if (dateTimeStr == null || dateTimeStr.isEmpty()) {
            return null;
        }
        ...
        try {
            ...
            logger.warn("Failed to parse date time with time: {}", dateTimeStr);
            return null;
        }
    }
