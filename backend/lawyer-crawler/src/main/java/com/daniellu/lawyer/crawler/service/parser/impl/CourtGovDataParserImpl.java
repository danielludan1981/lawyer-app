...
/**
 * 最高人民法院官网页面解析器
 * 支持的URL前缀为https://www.court.gov.cn
 *
 * @author Daniel Lu
 * @since 2026-01-17
 */
@Component
public class CourtGovDataParserImpl extends AbstractDataParser {
    ...
    protected Object parseMap(Map<String, Object> data, Map<String, Object> metadata) {
        throw new UnsupportedOperationException("CourtGovDataParserImpl does not support parseMap");
    }
    ...
    private ArticleDTO parseArticle(Map<String, Object> item, String baseUrl) {
        ...
        Element publishedAtElement = Jsoup.parse(publishedAtHtml).selectFirst("i");
