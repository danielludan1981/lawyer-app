...
/**
 * 中国人大网页面解析器
 * 支持的URL前缀为http://www.npc.gov.cn/npc/c2/c12435
 *
 * @author Daniel Lu
 * @since 2026-01-17
 */
@Component
public class NpcGovDataParserImpl extends AbstractDataParser {
    ...
    protected Object parseMap(Map<String, Object> data, Map<String, Object> metadata) {
        throw new UnsupportedOperationException("NpcGovDataParserImpl does not support parseMap");
    }
